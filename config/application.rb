...
#    config.force_ssl = false
    ...
    ActionView::Base.field_error_proc = Proc.new do |html_tag, instance_tag|
      ...
      first_whitespace = html_tag =~ /\s/
      html_tag[first_whitespace] = ' rel="popover" data-trigger="focus" data-content="<ul><li>' + Array(instance_tag.error_message).join('</li><li>') + '</li></ul>" data-original-title="This field... " '
      html_tag  
    end
