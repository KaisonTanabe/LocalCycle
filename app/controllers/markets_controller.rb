class MarketsController < ApplicationController
  ...
  def create
    respond_to do |format|
      if @market.save
        format.html { redirect_to admin_signed_in? ? markets_path : users_path, notice: 'Market successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @market.update_attributes(params[:market])
        format.html { redirect_to admin_signed_in? ? markets_path : users_path, notice: 'Market was successfully updated.' }
